...
/// @title ParaSwap Fork Tests (Ethereum Mainnet)
/// @notice End-to-end tests using real ParaSwap API on Ethereum mainnet fork
/// @dev Run with: forge test --match-path test/fork/ParaSwap.mainnet.t.sol --ffi -vvv
...
///      forge test --match-test test_ExactInput_WethToUsdc --match-path test/fork/ParaSwap.mainnet.t.sol --ffi -vv
contract ParaSwapMainnetTest is Test {
    // Ethereum mainnet constants
    uint256 constant ETH_CHAIN_ID = 1;
    address constant WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address constant USDC = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
    address constant PARASWAP_REGISTRY = 0xa68bEA62Dc4034A689AA0F58A76681433caCa663;
